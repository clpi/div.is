...
let s:palette.markup    = {'dark': "#FF6e63",  'light': "#F07178",  'mirage': "#F07178"}
let s:palette.constant  = {'dark': "#d4c3ff",  'light': "#A37ACC",  'mirage': "#D4BFFF"}
let s:palette.operator  = {'dark': "#bf80f0",  'light': "#E7C547",  'mirage': "#80D4FF"}
let s:palette.tag       = {'dark': "#faef8f",  'light': "#36A3D9",  'mirage': "#5CCFE6"}
let s:palette.regexp    = {'dark': "#6beff7",  'light': "#4CBF99",  'mirage': "#95E6CB"}
let s:palette.string    = {'dark': "#bfff7f",  'light': "#86B300",  'mirage': "#BBE67E"}
let s:palette.function  = {'dark': "#ffba7e",  'light': "#F29718",  'mirage': "#FFD57F"}
let s:palette.special   = {'dark': "#7befff",  'light': "#E6B673",  'mirage': "#FFC44C"}
let s:palette.keyword   = {'dark': "#FF7A7E",  'light': "#FF7733",  'mirage': "#FFAE57"}

let s:palette.error     = {'dark': "#FF3333",  'light': "#FF3333",  'mirage': "#FF3333"}
let s:palette.accent    = {'dark': "#FF5e53",  'light': "#FF6A00",  'mirage': "#FFCC66"}
...
exe "hi! NERDTreeCWD"               .s:fg_string        .s:bg_none        .s:fmt_none
exe "hi! NERDTreeUp"                .s:fg_fg_idle    .s:bg_none        .s:fmt_none
exe "hi! NERDTreeDir"               .s:fg_keyword   .s:bg_none        .s:fmt_none
exe "hi! NERDTreeFile"              .s:fg_fg       .s:bg_none        .s:fmt_none
exe "hi! NERDTreeDirSlash"          .s:fg_tag     .s:bg_none        .s:fmt_none
